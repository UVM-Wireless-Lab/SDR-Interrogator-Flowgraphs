...
# Title: CL Frequency Sweep
# Author: Rye Fought (ryesof@gmail.com)
# Description: Script for sweeping frequency. Records the received power and the difference: GTx-PRx
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "CL Frequency Sweep", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CL Frequency Sweep")
        ...
        self.tab_grid_layout_0.addWidget(self._GTx_tool_bar, 0, 0, 1, 2)
        for r in range(0, 1):
            self.tab_grid_layout_0.setRowStretch(r, 1)
        for c in range(0, 2):
            self.tab_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._FTx_tool_bar, 1, 1, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.portable_interrogator_blocks_CL_Sweep_Controller_0 = portable_interrogator_blocks.CL_Sweep_Controller(Sweep, Start, Stop, Step, buffer, Average, path, getPow.nextPow(outlen),name,appendDT,GTx)
        ...
        self.blocks_msgpair_to_var_0 = blocks.msg_pair_to_var(self.set_FTx)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.blocks_var_to_msg_0, 'msgout'), (self.qtgui_freq_sink_x_1, 'freq'))
    ...
    def set_RxShift(self, RxShift):
        ...
        self.blocks_var_to_msg_0.variable_changed(self.FRx+self.RxShift)
    ...
    def set_samp_rate_src(self, samp_rate_src):
        ...
        self.qtgui_freq_sink_x_1.set_frequency_range(0, (self.samp_rate_src/self.Decimation))
    ...
    def set_GTx(self, GTx):
        ...
        self.portable_interrogator_blocks_CL_Sweep_Controller_0.set_tx_gain(self.GTx)
