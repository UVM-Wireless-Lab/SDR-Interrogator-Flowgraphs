...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "CSB Sweep", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CSB Sweep")
        ...
        self._buffer_line_edit.returnPressed.connect(
            lambda: self.set_buffer(int(str(self._buffer_line_edit.text()))))
        ...
        self._Mod_ind_tool_bar.addWidget(Qt.QLabel("Mod Index (0-1)" + ": "))
        ...
        self.tab_grid_layout_0.addWidget(self._Mod_ind_tool_bar, 0, 4, 1, 2)
        for r in range(0, 1):
            self.tab_grid_layout_0.setRowStretch(r, 1)
        for c in range(4, 6):
            self.tab_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_number_sink_0_win, 1, 3, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
